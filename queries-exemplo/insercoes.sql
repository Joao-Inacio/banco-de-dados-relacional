-- Active: 1691416914754@@127.0.0.1@3306@johns_enterprise_db
...
VALUES 
(1, 1, 10),  # João é um cliente e também um funcionário
(3, NULL, 5);  # Pedro Lima é um cliente com desconto por ser dependente
...
('Produto B', 'Descrição do Produto B', 80.00, 'Seminovo');

# Povoando a tabela pedido
INSERT INTO pedido (id_cliente, valortotal)
VALUES 
(1, 90.00);  # Pedido de João com desconto aplicado na lógica da aplicação

# Povoando a tabela itenspedido
INSERT INTO itenspedido (id_pedido, id_produto, quantidade, precovenda)
VALUES 
(1, 1, 1, 90.00);  # Produto A foi vendido para João com desconto
